  ...
  return (
    <div className="pt-2 bg-[#F6B847] min-h-[50vh]">
      ...
      <div className="h-full max-w-[954px] mx-auto flex items-center justify-center flex-col pt-20 pb-20">
        <div className="min-w-[163px] text-xs md:text-base h-[35px] bg-[#198046] text-white flex items-center justify-center font-semibold px-6 py-6">Roadtrip Community</div>
        <h1 className="text-[36px] md:text-[64px] uppercase text-center font-semibold text-black font-clash leading-10 md:leading-20 mt-3">Empowering the African Talent on The road to Success</h1>
